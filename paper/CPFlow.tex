...
\begin{table*}[]
	\begin{tabular}{@{}ccccc@{}}
		\toprule
		Circuit               & CPFlow  & SQUANDER & QSearch & QFast+Qiskit+SQUANDER \\ \midrule
...
In this paper we presented a new approach to the problem of variational synthesis into CNOT/\CZ+1q gate set. We identified the problem of local minimums as a crucial yet underappreciated obstacle to the variational synthesis. We also proposed the use of the parametric 2q gates to unify the architecture search with the continuous optimization of 1q gates into a single coherent optimization and demonstrated its efficiency.
